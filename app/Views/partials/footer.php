 ...
 <div class="footer-area-style-with-black-color">
            <div class="container">
                ...
                <div class="copyright-area">
                    <p>Copyright <script>document.write(new Date().getFullYear())</script> <strong>NitiApp</strong>.</p>
                </div>
            </div>

            <div class="footer-white-shape">
                <img src="<?php echo base_url(); ?>assets/img/more-home/footer/footer-shape.png" alt="image">
            </div>
        </div>
